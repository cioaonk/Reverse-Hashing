...
def usage():
    print(f'usage: python3 {sys.argv[0]} [first6] [last4] [matchHash]')
...
#print(f'last4 = {last4}')
#print(f'Matching hash = {matchHash}')
cards = 0
...
while (cardnum <=  endnumber):
    ...
    if is_luhn_valid(cardnum):
        ...
        yourHex = myHash.hex()
        if yourHex == matchHash:
            # print("Full card number below:")
            print (f'{cardnum}')
            #print ("\n")
            break
    cardnum += 10000
